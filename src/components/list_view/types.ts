...
interface ListViewProps extends Omit<FlatListProps<ListViewItemProps>, 'renderItem' | 'ListEmptyComponent' | 'ListHeaderComponent' | 'ListFooterComponent' | 'data'>, Pick<ListViewItemProps, 'topButton' | 'bottomButton'> {
